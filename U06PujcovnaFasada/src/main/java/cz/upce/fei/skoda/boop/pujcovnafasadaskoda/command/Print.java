...
/**
 * Class representing print command
 * @author Jiri Skoda <jiri.skoda@student.upce.cz>
 */
public class Print extends Command
{
    /**
     * Creates new handler for print command
     * @param dataManager Manager of data
     */
    public Print(IManager dataManager)
    {
        super(dataManager);
        this.aliases = new String[]{"print", "prnt", "vypis", "p"};
    }
    ...
    {
        return """
               Vypise vsechny prvky ze seznamu
               """;
    }
    ...
    public String execute(String[] arguments)
    {
        ...
        for(Mappable m: this.dataManager.getAllData())
        {
