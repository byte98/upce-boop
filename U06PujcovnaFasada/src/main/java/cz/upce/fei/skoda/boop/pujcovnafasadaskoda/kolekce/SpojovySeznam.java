...
public interface SpojovySeznam<E> extends Iterable<E> {
     ...
     *
     * Upozornění: Tato metoda posouvá vnitřní ukazatel, který je pro danou
     * instanci součástí jejího stavu. Instanci seznamu lze taky procházet
     * iterátorem, který je zvláštním objektem, který bude vytvořen podle
     * vnitřní třídy s interfejsem Iterator. Každá žádost o iterátor seznamu
     * vytvoří nový objekt s vlastním ukazatelem na procházení položek objektu
     * seznamu.
     *
     * @throws KolekceException Výjimka se vystaví v případě, že nebyl nastaven
     * aktuální prvek nebo byl v předchozím volání dosa6en poslední prvek.
     */
    ...
    /**
     * Vkládací metoda vlozPredAktualnim() vloží nový prvek s daty před aktuální
     * prvek. Tato metoda je složitější na implementaci, protože jsme omezeni
     * jednosměrným řazením prvků seznamu.
     *
     * Proto je tato metoda deklarována jako "default" a tím pádem má definované
     * tělo již v rozhraní. To umožňuje tuto metodu vynechat v implementační
     * třídě. Implementace je dobrovolná.
     *
     * @param data Datová entita typu E
     *
     * @throws KolekceException Výjimka se vystaví, když není nastaven aktuální
     * prvek.
     *
     * @throws NullPointerException Výjimka se vystaví, když argument metody je
     * null.
     */
    default void vlozPredAktualnim(E data) throws KolekceException {
     ...
     * tuto metodu vynechat v implementační třídě. Implementace je dobrovolná.
     *
     * @throws KolekceException Tato výjimka se vystaví, když je seznam prázdný
     * nebo když není nastaven aktuální prvek.
     */
     ...
     * aktuálním a zajistí souvislé propojení zbylých prvků seznamu.
     *
     * Metoda mění počet dat v seznamu.
     *
     * @return Vrací odkaz na odebíraný objekt, datovou entitu typu E
     *
     * @throws KolekceException tato výjimka se vystaví, když nebyl nastaven
     * aktuální prvek nebo když byl seznam prázdný.
     */
    ...
    /**
     * Metoda převede obsah seznamu na datovy proud, který předá při návratu.
     *
     * Tato metoda se nepřekrývá.
     *
     * @return datovy proud
     */
