...
public abstract class Command
{
    ...
    /**
     * Manager of data used by system
     */
    protected final IManager dataManager;
    
    /**
     * Creates new command handler
     * @param dataManager Manager of data
     */
    public Command(IManager dataManager)
    {
    ...
    /**
     * Checks, whether additional information messages are expected or not
     * @return TRUE if additional messages are expected, FALSE otherwise
     */
